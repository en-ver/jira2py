...
- **Machine-readable documentation for AI agents:**
    ...
    - [`llms.txt`](llms.txt) / [`llms-full.txt`](llms-full.txt) — following the [llmstxt.org](https://llmstxt.org/) standard, generated by [mkdocs-llmstxt](https://github.com/pawamoy/mkdocs-llmstxt)
