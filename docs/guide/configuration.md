...
2. **An explicit JSON credentials file path** via `credentials_file=...`.
...
2. Values loaded from `credentials_file`, if you passed one
3. Environment variables (`JIRA_URL`, `JIRA_USER`, `JIRA_API_TOKEN`)
