...
1. read its JQL
1. run that JQL with [`jira.search.enhanced_search`](https://jira2py.org/api/issue-search/index.md)

The helper-layer shortcut for this is `helpers.filters.run()`; see [High-level Helpers](https://jira2py.org/api/helpers/index.md).

[Jira REST API — Filters](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-filters/)
