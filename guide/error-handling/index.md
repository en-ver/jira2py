...
1. `errors` — a dictionary of field-level errors (values are extracted)
1. `message` — a single error string
...
For the full exception class reference, see [Exceptions](https://jira2py.org/api/exceptions/index.md).
